...
const ShareEmailListFiuture = () => {
  return (
    <View style={styles.shareEmailListFiuture}>
      <View style={styles.shareEmailListFiutureInner}>
      ...
      />
      <Section1
        dimensionCode={require('../assets/noun-clipboard-1968677-2.png')}
        propOverflow="hidden"
      />
      <Section1
      ...
      />
      <Section1
        dimensionCode={require('../assets/noun-loading-1328151-2.png')}
        propOverflow="hidden"
      />
      <Section1
        dimensionCode={require('../assets/noun-clipboard-1968677-2.png')}
...
const styles = StyleSheet.create({
  ...
  shareEmailListFiutureInner: {
    paddingHorizontal: Padding.p_11xs,
    paddingVertical: 0,
    alignSelf: 'stretch',
  },
  shareEmailListFiuture: {
...
export default ShareEmailListFiuture;
