...
const ShipmentCard = () => {
  return (
    <View style={[styles.shipmentCard, styles.shipmentCardBg]}>
      ...
      <View style={styles.frameContainer}>
        <View style={styles.spfbom23110024Wrapper}>
          <Text style={[styles.rightIcon, styles.commentsTypo]}>
            container-storage
          </Text>
        ...
        <View style={[styles.rightIconGroup, styles.dataInputDateFlexBox]}>
      ...
      <View style={styles.shipmentCardChild} />
      <View style={[styles.partyDetails, styles.partyDetailsLayout]}>
        ...
        <View style={[styles.dataInputDate, styles.dataInputDateFlexBox]}>
          <Text style={styles.text}>On Time</Text>
        </View>
      </View>
      <View style={[styles.shipmentCardInner, styles.partyDetailsLayout]}>
        <View style={styles.frameGroup}>
          <View>
            <View>
              <View style={styles.spfbom23110024Wrapper}>
          ...
          <View style={styles.timelinePlaceOfCarrierRe2}>
            <View>
              <Text style={[styles.comments, styles.commentsTypo]}>anchor</Text>
              <View style={styles.frameWrapper1}>
                <View>
                  <Text
                    style={[
